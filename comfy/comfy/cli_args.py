...
cache_group.add_argument("--cache-ram", nargs='?', const=4.0, type=float, default=2.0, help="Use RAM pressure caching with the specified headroom threshold. If available RAM drops below the threhold the cache remove large items to free RAM. Default 4GB")
