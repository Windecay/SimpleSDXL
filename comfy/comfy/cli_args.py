...
dynamic_vram_group = parser.add_mutually_exclusive_group()
dynamic_vram_group.add_argument("--enable-dynamic-vram", action="store_true", help="Enable dynamic VRAM model loading (default: disabled).")
dynamic_vram_group.add_argument("--disable-dynamic-vram", action="store_true", help="Disable dynamic VRAM and use estimate based model loading.")
...
def enables_dynamic_vram():
    if getattr(args, "disable_dynamic_vram", False):
        return False
    if not getattr(args, "enable_dynamic_vram", False):
        return False
    return not args.highvram and not args.gpu_only and not args.novram and not args.cpu
