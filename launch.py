...
def check_base_environment():
    ...
    if torch.__version__ == '2.9.1+cu130':
        ...
        update_pkgs = [('comfyui_frontend_package', '1.39.19'), ('comfyui_workflow_templates', '0.9.10'), ('comfyui-embedded-docs', '0.4.3'), ('comfy-kitchen', '0.2.7'), ('comfy-aimdo', '0.2.7'), ('transformers', '4.57.1'), ('PyOpenGL', '3.1.10'), ('glfw', '2.10.0')]
        ...
        update_pkgs = [('comfyui_frontend_package', '1.39.19'), ('comfyui_workflow_templates', '0.9.10'), ('comfyui-embedded-docs', '0.4.3'), ('transformers', '4.57.1'), ('bitsandbytes', '0.45.5'), ('accelerate', '1.10.1'), ('av', '14.2.0'), ('yarl', '1.18.0'), ('gguf', '0.14.0'),
                       ...
                       ('mmdet', '3.3.0'), ('mmengine', '0.10.7'), ('munkres', '1.1.4'), ('terminaltables', '3.1.10'), ('color-matcher', '0.6.0'), ('natsort', '8.4.0'), ('olefile', '0.47'), ('taichi', '1.7.4'), ('torchdiffeq', '0.2.5'), ('lark', '1.3.1'), ('comfy-kitchen', '0.2.7'), ('comfy-aimdo', '0.2.7'), ('PyOpenGL', '3.1.10'), ('glfw', '2.10.0')]
        for (update_pkg_name, update_pkg_version) in update_pkgs:
            if not is_installed_version(update_pkg_name, update_pkg_version):
                success = install_package_with_retry(update_pkg_name, update_pkg_version)
                if not success:
