...
def check_base_environment():
    ...
    if is_installed("sageattention"):
        ...
        update_pkgs = [('comfyui_frontend_package', '1.33.10'), ('comfyui_workflow_templates', '0.7.25'), ('comfyui-embedded-docs', '0.3.1'), ('transformers', '4.56.2'), ('bitsandbytes', '0.45.5'), ('accelerate', '1.10.1'), ('av', '14.2.0'), ('yarl', '1.18.0'), ('gguf', '0.14.0'),
                       ...
                       ('mmdet', '3.3.0'), ('mmengine', '0.10.7'), ('munkres', '1.1.4'), ('terminaltables', '3.1.10'), ('color-matcher', '0.6.0'), ('natsort', '8.4.0'), ('olefile', '0.47')]
