...
def check_base_environment():
    ...
    if is_installed("sageattention"):
        ...
        update_pkgs = [('comfyui_frontend_package', '1.35.9'), ('comfyui_workflow_templates', '0.7.69'), ('comfyui-embedded-docs', '0.3.1'), ('transformers', '4.56.2'), ('bitsandbytes', '0.45.5'), ('accelerate', '1.10.1'), ('av', '14.2.0'), ('yarl', '1.18.0'), ('gguf', '0.14.0'),
