...
def check_base_environment():
    ...
    if torch.__version__ == '2.9.1+cu130':
        ...
        update_pkgs = [('comfyui_frontend_package', '1.41.18'), ('comfyui_workflow_templates', '0.9.21'), ('comfyui-embedded-docs', '0.4.3'), ('comfy-kitchen', '0.2.8'), ('comfy-aimdo', '0.2.10'), ('transformers', '4.57.6'), ('PyOpenGL', '3.1.10'), ('glfw', '2.10.0'), ('blake3', '1.0.8')]
