...
def check_base_environment():
    ...
    if is_installed("sageattention"):
        ...
        update_pkgs = [('comfyui_frontend_package', '1.26.13'), ('comfyui_workflow_templates', '0.1.81'), ('comfyui-embedded-docs', '0.2.6'), ('transformers', '4.56.2'), ('bitsandbytes', '0.45.5'), ('accelerate', '1.10.1'), ('av', '14.2.0'), ('yarl', '1.18.0'), ('gguf', '0.14.0'),
                       ...
                       ('GitPython', '3.1.45'), ('PyGithub', '2.8.1'), ('matrix-nio', '0.24.0'), ('toml', '0.10.2'), ('uv', '0.9.3'), ('clip-interrogator', '0.6.0'), ('simpleeval', '1.0.3'), ('compel', '2.3.0'), ('rotary-embedding-torch', '0.8.9')]
